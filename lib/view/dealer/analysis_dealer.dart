...
class AnalysisDealer extends StatelessWidget {
  const AnalysisDealer({super.key});
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            // ),
            // SizedBox(height: 10,),
            Text(' مبيعات شهر اكتوبر ', style: TextStyles.font22mainColorW600),
            ...
            Divider(),
            const SizedBox(height: 10),
            Text(' مبيعات شهر نوفمبر ', style: TextStyles.font22mainColorW600),
            const SizedBox(height: 20),
            Container(
              height: 450,
              child: BarChart(
